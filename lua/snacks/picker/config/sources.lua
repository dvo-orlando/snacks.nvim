...
M.explorer = {
  ...
  win = {
    list = {
      keys = {
        ["<BS>"] = "explorer_up",
        ["<CR>"] = "explorer_treemap_confirm", -- confirm; treemap-aware when the treemap view is toggled on
        ["l"] = "explorer_treemap_right", -- confirm, or move right in treemap view
        ["h"] = "explorer_treemap_left", -- close directory, or move left in treemap view
        ["j"] = "explorer_treemap_down", -- list down, or move down in treemap view
        ["k"] = "explorer_treemap_up", -- list up, or move up in treemap view
        ["T"] = "explorer_treemap_toggle", -- toggle the treemap view
        ["a"] = "explorer_add",
        ["d"] = "explorer_del",
        ["r"] = "explorer_rename",
        ["c"] = "explorer_copy",
